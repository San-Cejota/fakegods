const data = {
  ...
  items: [
    ...
    {
      id: 2,
      title: "AMIRI BLACK-WHITE ‘SKEL TOP LOW’",
      price: 600,
      image: require('./images/amirib.jpg'),
      category: "amiri",
    ...
    {
      id: 3,
      title: "BAD BUNNY X RESPONSE CL 'PASO FINO'",
      price: 599,
      image: require('./images/badbunny.jpg'),
      category: "adidas",
    ...
    },
    {
      ...
      price: 410,
      image: require('./images/blackcat.jpg'),
      category: "jordan",
    ...
    {
      id: 5,
      title: "AIR JORDAN 3 RETRO 'UNC'",
      price: 370,
      image: require('./images/jordan3.jpg'),
      category: "jordan",
    ...
    },
    {
      ...
      price: 390,
      image: require('./images/jordan_azul.jpg'),
      category: "jordan",
    ...
    {
      id: 9,
      title: "FRAGMENT DESIGN X TRAVIS SCOTT X AIR JORDAN RETRO 1 LOW",
      price: 400,
      image: require('./images/travis_azul.jpg'),
      category: "jordan",
    ...
    {
      id: 10,
      title: "TRAVIS SCOTT X AIR JORDAN 1 LOW OG SP 'BLACK PHANTOM'",
      price: 430,
      image: require('./images/travis.jpg'),
      category: "jordan",
